...
using std::cout;
using std::endl;
template <class FirstInfo, class SecondInfo, class ThirdInfo, int pid = 0, int doVertexFit = 0>
class CombThreeInfo : virtual public AvailableInfo {
   public:
    ...
    CombThreeInfo(FirstInfo& firsInfo, SecondInfo& secondInfo, ThirdInfo& thirdInfo) {
    ...
    void Feed(FirstInfo& firsInfo, SecondInfo& secondInfo, ThirdInfo& thirdInfo) {
        m_firstInfo = firsInfo;
        m_secondInfo = secondInfo;
        m_thirdInfo = thirdInfo;
        m_firstInfo.SetName(m_firstInfo.GetName() + HadronTool::Name(m_pid));
   ...
   private:
    ...
    void AddAvialInfo() {
        ...
        AddInfo(m_thirdInfo.GetType("double"), "double",
                m_thirdInfo.GetName());
