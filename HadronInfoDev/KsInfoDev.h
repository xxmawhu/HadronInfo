#ifndef CLASS_KSINFODev_H
#define CLASS_KSINFODev_H
...
class KsInfoDev : public VeeInfoDev {
   public:
    // KsInfoDev() : VeeInfoDev("Pionp", "Pionm") {};
    KsInfoDev(const string &name1 = "Pionp", const string &name2 = "Pion")
        : VeeInfoDev(name1, name2) {
        VeeInfoDev::setChildName(0, name1);
        VeeInfoDev::setChildName(1, name2);
    }

    KsInfoDev(const EvtRecTrack *track0, const EvtRecTrack *track1,
    ...
    KsInfoDev(const CDCandidate &aLambda, const string &name1 = "Pionp",
    ...
    // KsInfoDev &operator=(KsInfoDev &aKsInfoDev);
