#ifndef CLASS_OMEGAINFODev_H
#define CLASS_OMEGAINFODev_H
...
class OmegaInfoDev : public AvailableInfoDev {
   public:
    OmegaInfoDev();
    OmegaInfoDev(const EvtRecTrack *, const EvtRecTrack *, const EvtRecTrack *);
    OmegaInfoDev(const CDCandidate &aOmega);
    ~OmegaInfoDev();

    virtual const double &GetDoubleInfoDev(const string &);
    virtual const HepLorentzVector &GetLorentzVector(const string &info_name);
    // OmegaInfoDev &operator=(OmegaInfoDev &aOmegaInfoDev);
