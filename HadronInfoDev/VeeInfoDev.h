#ifndef CLASS_VEEINFODev_H
#define CLASS_VEEINFODev_H
...
class VeeInfoDev : public AvailableInfoDev {
   public:
    VeeInfoDev(const string &name1 = "First", const string &name2 = "Second")
        : AvailableInfoDev() {
        m_cal = false;
        m_childName[0] = name1;
        m_childName[1] = name2;
    ...
    VeeInfoDev(const CDCandidate &aVee, const string &name1 = "First",
            const string &name2 = "Second")
        : AvailableInfoDev() {
            cout << " init VeeInfoDev " << endl;
    ...
    VeeInfoDev(const EvtRecTrack *track0, const EvtRecTrack *track1,
   ...
   private:
    ...
    virtual void addAvialInfoDev() {
        ...
        AvailableInfoDev::add("rawmass", "double");
        AvailableInfoDev::add("vertexFitChisq", "double");
        AvailableInfoDev::add("secondVertexFitChisq", "double");
        AvailableInfoDev::add("decayLength", "double");
        AvailableInfoDev::add("decayLengthError", "double");
        AvailableInfoDev::add("decayLengthRatio", "double");
        AvailableInfoDev::add("p4", "HepLorentzVector");
        AvailableInfoDev::add("p4" + getChildName(0), "HepLorentzVector");
        AvailableInfoDev::add("p4" + getChildName(1), "HepLorentzVector");
        AvailableInfoDev::add("p4Fit" + getChildName(0), "HepLorentzVector");
        AvailableInfoDev::add("p4Fit" + getChildName(1), "HepLorentzVector");
    }

   protected:
    //  VeeInfoDev &operator=(VeeInfoDev &aVeeInfoDev) {
    //      this->setM(aVeeInfoDev.m());
    //      m_p4 = aVeeInfoDev.p4();
    //      m_rawmass = aVeeInfoDev.rawmass();
    //      m_mass = aVeeInfoDev.m();
    //      m_chisqFirst = aVeeInfoDev.chisqFirst();
    //      m_chisqSecond = aVeeInfoDev.chi2();
    //      m_decayLength = aVeeInfoDev.decayLength();
    //      m_decayLengthRatio = aVeeInfoDev.decayLengthRatio();
    //      m_decayLengthError = aVeeInfoDev.decayLengthError();
    //      return *this;
    //  }
};
#endif
