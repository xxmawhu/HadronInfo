...
# ====================================================*/
#ifndef HadronInfoDev_COMTHREEDev_H
#define HadronInfoDev_COMTHREEDev_H
...
template <class FirstInfoDev, class SecondInfoDev,  class ThirdInfoDev,
         int pid = 0,
          int doVertexFit = 0>
class CombThreeDev : public AvailableInfoDev {
   public:
       CombThreeDev(const CDCandidate& combParticle) {
    ...
    CombThreeDev(FirstInfoDev& firsInfoDev, SecondInfoDev& secondInfoDev) {
        m_firstInfoDev = firsInfoDev;
        m_secondInfoDev = secondInfoDev;
        m_pid = pid;
        std::cout << "init CombThreeDev successful" << std::endl;
        m_calculate = false;
        // std::cout << "CombThreeDev " << endl;
    ...
    virtual bool calculate() {
        ...
        cout << "CombThreeDev " << __func__ << __LINE__ << endl;
