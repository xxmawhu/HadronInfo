...
#ifndef CLASS_Lambda_INFO_H
#define CLASS_Lambda_INFO_H
...
class LamInfo : public VeeInfo {
   public:
    ...
    LamInfo(const EvtRecTrack *track0, const EvtRecTrack *track1,
    ...
    LamInfo(const CDCandidate &aLambda, const string &name1 = "Proton",
    ...
    // LamInfo &operator=(LamInfo &aLamInfo);
    ...
    bool calculate() {
        ...
        WTrackParameter wvTrk1(mpion, protonTrk->getZHelix(),
                               protonTrk->getZError());
